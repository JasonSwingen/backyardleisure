...
<form id="signInForm" method="post" action="<?php echo get_bloginfo('template_url') . '/login.php'; ?>">
	<fieldset>
		...
		<input type="text" name="signInUsername" id="signInUsername" class="required" minlength="6" size="35" maxlength="10" value="<?php echo $_SESSION['uname']; ?>" />
		<label for="signInPassword"><?php _e('Password','wpShop');?></label>
		<input id="signInPassword" class="required" minlength="4" type="password" size="35" maxlength="8" value="" name="signInPassword"/>
