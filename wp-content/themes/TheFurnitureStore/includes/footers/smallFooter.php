...
<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('footer-tags-area') ) :?> <?php endif;   ?>
	<div class="container clearfix" align="center">
        ...
        <div class="footer_notes">
			<span class="copyright">&copy; <?php echo date('Y'); ?>. <a href="<?php bloginfo('url'); ?>"><?php bloginfo('name'); ?></a>. | <?php _e('All Rights Reserved','wpShop');?>. <a href="http://spapoolbilliards.com/privacy-policy">Privacy Policy</a></span>
			<?php 
			//custom menu?
