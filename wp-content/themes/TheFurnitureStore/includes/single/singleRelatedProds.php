...
if($OPTION['wps_blogTags_option']) {
	...
	$taxonomy_exist = is_taxonomy($taxTerm);
	if($taxonomy_exist) {
		$tag_related_output = NWS_term_related_posts($tagProdNum,$resizedImg_src,$img_size,$taxTerm);
...
if(($cat_related_output[status]) || ($tag_related_output[status])){?>
