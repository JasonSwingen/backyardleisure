...
<?php } elseif (is_taxonomy($customTax)){ 
...
<?php } elseif (($_GET[showCart] == '1') || ($_GET[orderNow] == '1') || ($_GET[orderNow] == '2') || ($_GET[orderNow] == '3') || ($_GET[orderNow] == '4') || ($_GET[orderNow] == '5') || ($_GET[orderNow] == '6') || ($_GET[orderNow] == '7') || ($_GET[confirm] == '1') || ($_GET[confirm] == '2') || ($_GET[confirm] == '3') || ($_GET[showTerms] == '1') || ($_GET[showMap] == 1) || ($_GET[checkOrderStatus] == 1)) {
