...
-->        
  ...
  <div id="blue-bg" >
  	<ul>
    	<li><a href="<?php bloginfo('url'); ?>/brands/swimming-pools">Swimming Pools</a></li>
        <li><a href="<?php bloginfo('url'); ?>/products">Hot Tubs</a></li>
        <li><a href="<?php bloginfo('url'); ?>/category/billiards">Billiards</a></li>
<!--    <li><a href="<?php //bloginfo('url'); ?>/brands/strip9">Pool Tables</a></li> -->  
      	<li><a href="<?php bloginfo('url'); ?>/brands/jacuzzi">Jacuzzi Spas</a></li>
        <li><a href="<?php bloginfo('url'); ?>/brands/bulfrog-spas">Bullfrog Spas</a></li>
        <li><a href="<?php bloginfo('url'); ?>/brands/hawkeye_spas">Hawkeye Spas</a></li>
      	<li><a href="<?php bloginfo('url'); ?>/dream-maker-spas">Dreammaker Spas</a></li>
        <li><a href="<?php bloginfo('url'); ?>/brands/barefoot-fitness-spas">Barefoot Fitness Spas</a></li>
    </ul>
  </div>
  <div id="blue-bg" >
...
<!--CUSTOMIZED AREA-->
<div id="blue-bg" style="margin-left:0px;">
<!--  <div class="widget shop_by_widget widget-shop-by-brand">
    <h3 class="widget-title" style="padding:5px;">Brands</h3>
    <?php //echo $select; ?> </div>
 --></div>
...
<?php } else {
	...
	$expURL=explode('/',$requestURI);
	$page=$expURL[1];
	if($page == "special-offers" && $page != ""){
	?>
        <div style="clear:both"></div>
<div class="sidebar page_sidebar noprint <?php echo $the_float_class;?>">
<?php }else{?>
<div class="sidebar page_sidebar noprint <?php echo $the_float_class;?>" style="float:left;">
<?php }?>
  <div class="padding">
    <div id="blue-bg">
      <!--Customized-->
